...
class Block(nn.Module):
    def __init__(self, n_embed, n_heads, num_experts, top_k, num_shared_experts = 2):
        # n_embed: embedding dimension, n_head: the number of heads we'd like
        super().__init__()
        self.mha = MultiHeadAttention(n_embed, n_heads)
        self.smoe = DeepSeekMoE(n_embed, num_experts, top_k)
...
class DeepSeekMoEDecoderModel(nn.Module):
